...
<!-- navbar -->
  ...
  <nav class="navbar navbar-expand-md row ">
    <div class="col-12 row" id="search">
    ...
    <form class="form-inline my-2 my-lg-0 col-12 d-flex flex-wrap align-content-start justify-content-start">
      <div class="form-group row">
        <input class="form-control mr-sm-2 col-9 align align-self-start" type="text" placeholder="Search" aria-label="Search">
        <button class="btn btn-primary  mr-sm-2 col-2 align-self-start" type="submit"> <span class="ion-ios-search-strong "></span> </button>
      </div>
    </form>
  </nav>
